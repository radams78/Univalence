...
\text{Proof} & \delta & ::= & \cdots \mid \reff{M} \mid \delta \supset^* \delta \mid \univ{\phi}{\phi}{\delta}{\delta} \mid \triplelambda e : x =_A x . \delta \mid \delta_{MM} \delta\\
& & & \quad \mid \delta =^*_A \delta \mid \delta^+ \mid \delta^-
\end{array}
\]

The rules of deduction of $\lambda o i$ are those of Figures \ref{fig:lambdao} and \ref{fig:lambdaoe}, together with:
...
\[ \reff{\phi} =^*_\Omega \univ{\psi}{\chi}{\delta}{\epsilon} \rhd 
  \univ{\phi =_\Omega \psi}{\phi =_\Omega \chi}
  {\lambda p:\phi =_\psi. \univ{\phi}{\chi}{\lambda q:\phi.\delta (p^+ q)}
    {\lambda q : \chi. p^- (\epsilon q)}}
  {\lambda p:\phi =_\Omega \chi. \univ{\phi}{\psi}{\lambda q:\phi. \epsilon (p^+ q)}
    {\lambda q : \psi. p^- (\delta q)}}\]
\[ \univ{\phi}{\psi}{\delta}{\epsilon} =^*_\Omega \reff{\chi} \rhd
  \univ{\phi =_\Omega \chi}{\psi =_\Omega \chi}
    {\lambda p:\phi = \chi . \univ{\psi}{\chi}{\lambda q:\psi. p^+ (\epsilon q)}
      {\lambda q:\chi. \delta (p^- q)}}
    {\lambda p:\psi =_\Omega \chi. \univ{\phi}{\chi}{\lambda q:\phi. p^+ (\delta q)}
      {\lambda q:\chi. \epsilon (p^- q)}} \]
\[ 
