...
\univ{\phi}{\psi}{\delta}{\epsilon} =^*_\Omega \univ{\phi'}{\psi'}{\delta'}{\epsilon'} & \rhd
...
\reff{F} =^*_{A \rightarrow B} \triplelambda^{G G'} e:x =_A y. P & \rhd
...
\triplelambda^{F F'} e : x =_A y. P =^*_{A \rightarrow B} \reff{G} & \rhd
\mathsf{univ}_{F =_{A \rightarrow B} G,F' =_{A \rightarrow B} G} \\
...
\triplelambda^{F F'} e : x =_A y. P =^*_{A \rightarrow B} \triplelambda^{G G'} e : x =_A y . Q
& \rhd 
\mathsf{univ}_{F =_{A \rightarrow B} G,F' =_{A \rightarrow B} G'} \\
