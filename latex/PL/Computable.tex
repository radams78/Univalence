...
\\
\>[8]\AgdaIndent{10}{}\<[10]%
\>[10]\AgdaSymbol{(}\AgdaFunction{magic-unique'} \AgdaBound{φ}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaInductiveConstructor{var} \AgdaSymbol{\_))} \<[37]%
\>[37]\<%
\\
\>[0]\AgdaIndent{8}{}\<[8]%
...
\AgdaHide{
\begin{code}%
\>\AgdaFunction{varC} \AgdaSymbol{\{}\AgdaBound{P}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Γ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{=} \AgdaFunction{NeutralC} \AgdaSymbol{(}\AgdaFunction{close} \AgdaSymbol{(}\AgdaFunction{typeof} \AgdaBound{x} \AgdaBound{Γ}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaFunction{change-type} \AgdaSymbol{(}\AgdaFunction{sym} \AgdaFunction{close-magic}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaInductiveConstructor{var} \AgdaBound{x}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaInductiveConstructor{varNeutral} \AgdaBound{x}\AgdaSymbol{)} \AgdaSymbol{(λ} \AgdaBound{ε} \AgdaSymbol{())}\<%
\end{code}
}
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaFunction{C} \AgdaBound{Γ} \AgdaBound{ψ} \AgdaSymbol{(}\AgdaFunction{appP} \AgdaBound{x} \AgdaBound{ε}\AgdaSymbol{))} \AgdaFunction{ap-idRep} \<[42]%
\>[42]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaBound{δ∈CΓφ⇛ψ} \AgdaBound{P} \AgdaSymbol{(}\AgdaFunction{idRep} \AgdaBound{P}\AgdaSymbol{)} \AgdaBound{ε} \AgdaFunction{idRep-typed} \AgdaBound{ε∈CΓφ}\AgdaSymbol{)}\<%
\end{code}
...
\\
\>\AgdaFunction{SNmainlemma} \AgdaSymbol{(}\AgdaInductiveConstructor{var} \AgdaBound{p}\AgdaSymbol{)} \AgdaBound{hyp} \AgdaSymbol{=} \AgdaBound{hyp} \AgdaBound{p}\<%
\\
