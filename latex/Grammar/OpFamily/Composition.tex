...
\begin{code}%
\>\AgdaComment{\{-  liftOp'-circ : ∀ \{U V W\} A \{σ ρ\} → \<\\
\>    \_∼op\_ H (liftOp' H A (circ \{U\} \{V\} \{W\} σ ρ)) \<\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{postulate} \AgdaPostulate{liftOp''-circ} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U} \AgdaBound{V} \AgdaBound{W} \AgdaBound{K}\AgdaSymbol{\}} \AgdaBound{A} \AgdaSymbol{\{}\AgdaBound{σ} \AgdaBound{ρ}\AgdaSymbol{\}} \AgdaSymbol{→} \<[50]%
\>[50]\<%
\\
\>[2]\AgdaIndent{26}{}\<[26]%
\>[26]\AgdaFunction{\_∼op\_} \AgdaBound{H} \AgdaSymbol{(}\AgdaFunction{liftOp''} \AgdaBound{H} \AgdaSymbol{\{}\AgdaArgument{K} \AgdaSymbol{=} \AgdaBound{K}\AgdaSymbol{\}} \AgdaBound{A} \AgdaSymbol{(}\AgdaField{circ} \AgdaSymbol{\{}\AgdaBound{U}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{W}\AgdaSymbol{\}} \AgdaBound{σ} \AgdaBound{ρ}\AgdaSymbol{))} \<[80]%
\>[80]\<%
\\
\>[2]\AgdaIndent{26}{}\<[26]%
\>[26]\AgdaSymbol{(}\AgdaField{circ} \AgdaSymbol{(}\AgdaFunction{liftOp''} \AgdaBound{F} \AgdaBound{A} \AgdaBound{σ}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{liftOp''} \AgdaBound{G} \AgdaBound{A} \AgdaBound{ρ}\AgdaSymbol{))}\<%
\end{code}
}
...
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{≡⟨} \AgdaFunction{ap-congl} \AgdaBound{H} \AgdaBound{E} \AgdaSymbol{(}\AgdaPostulate{liftOp''-circ} \AgdaBound{A}\AgdaSymbol{)} \AgdaFunction{⟩}\<%
\\
\>[4]\AgdaIndent{6}{}\<[6]%
