...
\\
\>\AgdaKeyword{open} \AgdaKeyword{import} \AgdaModule{Function.Equality} \AgdaKeyword{hiding} \AgdaSymbol{(}\AgdaRecord{Π}\AgdaSymbol{)}\<%
\\
...
\begin{code}%
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{LIFTOP'} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaBound{A} \AgdaSymbol{→} \AgdaFunction{OP} \AgdaBound{U} \AgdaBound{V} \AgdaFunction{⟶} \AgdaFunction{OP} \AgdaSymbol{(}\AgdaFunction{dom} \AgdaBound{U} \AgdaBound{A}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{dom} \AgdaBound{V} \AgdaBound{A}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{LIFTOP'} \AgdaSymbol{(}\AgdaInductiveConstructor{Π} \AgdaSymbol{\_} \AgdaSymbol{(\_} \AgdaInductiveConstructor{●}\AgdaSymbol{))} \AgdaSymbol{=} \AgdaFunction{id}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{LIFTOP'} \AgdaSymbol{(}\AgdaInductiveConstructor{Π} \AgdaSymbol{\_} \AgdaSymbol{(}\AgdaBound{K} \AgdaInductiveConstructor{⇒} \AgdaBound{A}\AgdaSymbol{))} \AgdaSymbol{=} \AgdaFunction{LIFTOP'} \AgdaSymbol{(}\AgdaInductiveConstructor{Π} \AgdaSymbol{\_} \AgdaBound{A}\AgdaSymbol{)} \AgdaFunction{∘} \AgdaFunction{LIFTOP} \AgdaBound{K}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{liftOp'} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaBound{A} \AgdaSymbol{→} \AgdaFunction{Op} \AgdaBound{U} \AgdaBound{V} \AgdaSymbol{→} \AgdaFunction{Op} \AgdaSymbol{(}\AgdaFunction{dom} \AgdaBound{U} \AgdaBound{A}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{dom} \AgdaBound{V} \AgdaBound{A}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{liftOp'} \AgdaBound{A} \AgdaSymbol{=} \AgdaField{Function.Equality.Π.\_⟨\$⟩\_} \AgdaSymbol{(}\AgdaFunction{LIFTOP'} \AgdaBound{A}\AgdaSymbol{)}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{liftOp'-cong} \AgdaBound{A} \AgdaSymbol{=} \AgdaField{Function.Equality.Π.cong} \AgdaSymbol{(}\AgdaFunction{LIFTOP'} \AgdaBound{A}\AgdaSymbol{)}\<%
\end{code}
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{ap-congl} \AgdaSymbol{\_} \AgdaInductiveConstructor{out} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{ap-congl} \AgdaBound{ρ-is-σ} \AgdaSymbol{(}\AgdaInductiveConstructor{\_,,\_} \AgdaSymbol{\{}\AgdaArgument{A} \AgdaSymbol{=} \AgdaBound{A}\AgdaSymbol{\}} \AgdaBound{E} \AgdaBound{F}\AgdaSymbol{)} \AgdaSymbol{=} \<[39]%
\>[39]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{cong₂} \AgdaInductiveConstructor{\_,,\_} \AgdaSymbol{(}\AgdaFunction{ap-congl} \AgdaSymbol{(}\AgdaFunction{liftOp'-cong} \AgdaBound{A} \AgdaBound{ρ-is-σ}\AgdaSymbol{)} \AgdaBound{E}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{ap-congl} \AgdaBound{ρ-is-σ} \AgdaBound{F}\AgdaSymbol{)}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
