...
\begin{code}%
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{LIFTOP'} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaBound{VV} \AgdaSymbol{→} \AgdaFunction{OP} \AgdaBound{U} \AgdaBound{V} \AgdaFunction{⟶} \AgdaFunction{OP} \AgdaSymbol{(}\AgdaFunction{extend} \AgdaBound{U} \AgdaBound{VV}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{extend} \AgdaBound{V} \AgdaBound{VV}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{LIFTOP'} \AgdaInductiveConstructor{[]} \AgdaSymbol{=} \AgdaFunction{id}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{LIFTOP'} \AgdaSymbol{(}\AgdaBound{W} \AgdaInductiveConstructor{∷} \AgdaBound{VV}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{LIFTOP'} \AgdaBound{VV} \AgdaFunction{∘} \AgdaFunction{LIFTOP} \AgdaBound{W}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{ap} \AgdaBound{ρ} \AgdaSymbol{(}\AgdaInductiveConstructor{\_∷\_} \AgdaSymbol{\{}\AgdaArgument{A} \AgdaSymbol{=} \AgdaInductiveConstructor{SK} \AgdaBound{AA} \AgdaSymbol{\_\}} \AgdaBound{E} \AgdaBound{EE}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{ap} \AgdaSymbol{(}\AgdaFunction{liftOp'} \AgdaBound{AA} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{E} \AgdaInductiveConstructor{∷} \AgdaFunction{ap} \AgdaBound{ρ} \AgdaBound{EE}\<%
\end{code}
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{cong₂} \AgdaInductiveConstructor{\_∷\_} \AgdaSymbol{(}\AgdaFunction{ap-congl} \AgdaSymbol{(}\AgdaFunction{liftOp'-cong} \AgdaBound{AA} \AgdaBound{ρ-is-σ}\AgdaSymbol{)} \AgdaBound{E}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{ap-congl} \AgdaBound{ρ-is-σ} \AgdaBound{F}\AgdaSymbol{)}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
