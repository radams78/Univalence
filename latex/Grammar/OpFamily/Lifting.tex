...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{LIFTOP'} \AgdaSymbol{(}\AgdaInductiveConstructor{out} \AgdaSymbol{\_)} \AgdaSymbol{=} \AgdaFunction{id}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{LIFTOP'} \AgdaSymbol{(}\AgdaInductiveConstructor{Π} \AgdaBound{K} \AgdaBound{A}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{LIFTOP'} \AgdaBound{A} \AgdaFunction{∘} \AgdaFunction{LIFTOP} \AgdaBound{K}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
