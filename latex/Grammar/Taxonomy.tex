...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{\_⟶\_} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaField{VarKind} \AgdaSymbol{→} \AgdaDatatype{AbstractionKind} \AgdaBound{K} \AgdaSymbol{→} \AgdaDatatype{AbstractionKind} \AgdaBound{K}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
