...
\>[9]\AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaDatatype{AbstractionKind} \AgdaSymbol{→} \AgdaFunction{ConstructorKind} \AgdaBound{K} \AgdaSymbol{→} \AgdaFunction{ConstructorKind} \AgdaBound{K}\<%
\end{code}
\end{frame}
