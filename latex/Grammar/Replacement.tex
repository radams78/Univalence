...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaField{isOpFamily} \AgdaSymbol{=} \AgdaKeyword{record} \AgdaSymbol{\{}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaField{comp} \AgdaSymbol{=} \AgdaKeyword{record} \AgdaSymbol{\{} \<[20]%
\>[20]\<%
\\
\>[4]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaField{\_∘\_} \AgdaSymbol{=} \AgdaFunction{\_•R\_} \AgdaSymbol{;} \<[19]%
\>[19]\<%
\\
\>[4]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaField{apV-comp} \AgdaSymbol{=} \AgdaInductiveConstructor{refl} \AgdaSymbol{;} \<[24]%
\>[24]\<%
\\
\>[4]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaField{liftOp-comp} \AgdaSymbol{=} \AgdaFunction{liftRep-comp} \AgdaSymbol{\}} \AgdaSymbol{\}} \AgdaSymbol{\}}\<%
\end{code}
