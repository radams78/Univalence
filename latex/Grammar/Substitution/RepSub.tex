...
%
\\
\>\AgdaKeyword{open} \AgdaModule{OpFamily} \AgdaFunction{replacement} \AgdaKeyword{using} \AgdaSymbol{()} \AgdaKeyword{renaming} \AgdaSymbol{(}liftsOp \AgdaSymbol{to} liftsOpR\AgdaSymbol{)}\<%
\\
