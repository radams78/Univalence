...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{(}\AgdaBound{circ₁} \AgdaSymbol{:} \AgdaRecord{Composition} \AgdaBound{F} \AgdaFunction{proto-substitution} \AgdaFunction{proto-substitution}\AgdaSymbol{)} \<[64]%
\>[64]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{(}\AgdaBound{circ₂} \AgdaSymbol{:} \AgdaRecord{Composition} \AgdaFunction{proto-substitution} \AgdaBound{F} \AgdaFunction{proto-substitution}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaRecord{Composition} \AgdaBound{F} \AgdaFunction{proto-substitution} \AgdaFunction{proto-substitution} \AgdaSymbol{→}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaRecord{Composition} \AgdaFunction{proto-substitution} \AgdaBound{F} \AgdaFunction{proto-substitution} \AgdaSymbol{→}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\AgdaHide{
\begin{code}%
\>\AgdaFunction{comp-botsub} \AgdaBound{F} \AgdaSymbol{=} \AgdaKeyword{let} \AgdaBound{COMP} \AgdaSymbol{=} \AgdaFunction{OpFamily.COMP} \AgdaFunction{substitution} \AgdaKeyword{in} \AgdaFunction{circ-botsub} \AgdaSymbol{\{}\AgdaArgument{E'} \AgdaSymbol{=} \AgdaBound{F}\AgdaSymbol{\}} \AgdaBound{COMP} \AgdaBound{COMP}\<%
\end{code}
}
...
\\
\>\AgdaFunction{botsub-botsub} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaBound{E} \AgdaBound{F} \AgdaBound{G} \AgdaSymbol{=} \AgdaKeyword{let} \AgdaBound{COMP} \AgdaSymbol{=} \AgdaFunction{OpFamily.COMP} \AgdaFunction{substitution} \AgdaKeyword{in} \AgdaFunction{ap-circ-sim} \AgdaBound{COMP} \AgdaBound{COMP} \AgdaSymbol{(}\AgdaFunction{botsub-botsub'} \AgdaBound{F} \AgdaBound{G}\AgdaSymbol{)} \AgdaBound{E}\<%
\\
%
\\
...
%
\\
\>\AgdaKeyword{postulate} \AgdaPostulate{botsub₃-Rep↑₃} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{K2}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{K1}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{K0}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}}\<%
\\
\>[2]\AgdaIndent{24}{}\<[24]%
\>[24]\AgdaSymbol{\{}\AgdaBound{M2} \AgdaSymbol{:} \AgdaFunction{Expression} \AgdaBound{U} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaBound{K2}\AgdaSymbol{)\}} \AgdaSymbol{\{}\AgdaBound{M1} \AgdaSymbol{:} \AgdaFunction{Expression} \AgdaBound{U} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaBound{K1}\AgdaSymbol{)\}} \AgdaSymbol{\{}\AgdaBound{M0} \AgdaSymbol{:} \AgdaFunction{Expression} \AgdaBound{U} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaBound{K0}\AgdaSymbol{)\}} \AgdaSymbol{\{}\AgdaBound{ρ} \AgdaSymbol{:} \AgdaFunction{Rep} \AgdaBound{U} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaBound{N} \AgdaSymbol{:} \AgdaFunction{Expression} \AgdaSymbol{(}\AgdaBound{U} \AgdaInductiveConstructor{,} \AgdaBound{K2} \AgdaInductiveConstructor{,} \AgdaBound{K1} \AgdaInductiveConstructor{,} \AgdaBound{K0}\AgdaSymbol{)} \AgdaBound{L}\AgdaSymbol{)} \AgdaSymbol{→}\<%
\\
\>[2]\AgdaIndent{24}{}\<[24]%
\>[24]\AgdaBound{N} \AgdaFunction{〈} \AgdaFunction{Rep↑} \AgdaSymbol{\_} \AgdaSymbol{(}\AgdaFunction{Rep↑} \AgdaSymbol{\_} \AgdaSymbol{(}\AgdaFunction{Rep↑} \AgdaSymbol{\_} \AgdaBound{ρ}\AgdaSymbol{))} \AgdaFunction{〉} \AgdaFunction{⟦} \AgdaFunction{x₂:=} \AgdaBound{M2} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉} \AgdaFunction{,x₁:=} \AgdaBound{M1} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉} \AgdaFunction{,x₀:=} \AgdaBound{M0} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉} \AgdaFunction{⟧}\<%
\\
\>[2]\AgdaIndent{24}{}\<[24]%
\>[24]\AgdaDatatype{≡} \AgdaBound{N} \AgdaFunction{⟦} \AgdaFunction{x₂:=} \AgdaBound{M2} \AgdaFunction{,x₁:=} \AgdaBound{M1} \AgdaFunction{,x₀:=} \AgdaBound{M0} \AgdaFunction{⟧} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\<%
\\
\>\AgdaComment{\{- botsub₃-Rep↑₃ \{M2 = M2\} \{M1\} \{M0\} \{ρ\} N = let open ≡-Reasoning in\<\\
\>              begin\<\\
