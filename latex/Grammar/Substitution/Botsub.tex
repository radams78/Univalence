...
\AgdaHide{
\begin{code}%
\>\AgdaFunction{botSub} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{A}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaDatatype{HetsnocList} \AgdaSymbol{(}\AgdaFunction{VExpression} \AgdaBound{V}\AgdaSymbol{)} \AgdaBound{A} \AgdaSymbol{→} \AgdaFunction{Sub} \AgdaSymbol{(}\AgdaFunction{snoc-extend} \AgdaBound{V} \AgdaBound{A}\AgdaSymbol{)} \AgdaBound{V}\<%
\\
...
\\
\>\AgdaFunction{xx₀:=\_} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V} \AgdaBound{KK}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaDatatype{HetsnocList} \AgdaSymbol{(}\AgdaFunction{VExpression} \AgdaBound{V}\AgdaSymbol{)} \AgdaBound{KK} \AgdaSymbol{→} \AgdaFunction{Sub} \AgdaSymbol{(}\AgdaFunction{snoc-extend} \AgdaBound{V} \AgdaBound{KK}\AgdaSymbol{)} \AgdaBound{V}\<%
\\
\>\AgdaFunction{xx₀:=\_} \AgdaSymbol{=} \AgdaFunction{botSub} \AgdaComment{-- TODO Inline}\<%
\\
%
\\
\>\AgdaFunction{liftsnocRep-botSub'} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U} \AgdaBound{V}\AgdaSymbol{\}} \AgdaBound{KK} \AgdaSymbol{\{}\AgdaBound{MM} \AgdaSymbol{:} \AgdaDatatype{HetsnocList} \AgdaSymbol{(}\AgdaFunction{VExpression} \AgdaBound{U}\AgdaSymbol{)} \AgdaBound{KK}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{ρ} \AgdaSymbol{:} \AgdaFunction{Rep} \AgdaBound{U} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{ρ} \AgdaFunction{•RS} \AgdaFunction{xx₀:=} \AgdaBound{MM} \AgdaFunction{∼} \AgdaFunction{xx₀:=} \AgdaFunction{snocListExp-rep} \AgdaBound{MM} \AgdaBound{ρ} \AgdaFunction{•SR} \AgdaFunction{liftsnocRep} \AgdaBound{KK} \AgdaBound{ρ}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{≡⟨⟨} \AgdaFunction{sub-•RS} \AgdaBound{E} \AgdaFunction{⟩⟩}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{≡⟨} \AgdaFunction{sub-•SR} \AgdaBound{E} \AgdaFunction{⟩}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
%
\\
\>\AgdaFunction{botSub-ups'} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaBound{KK} \AgdaSymbol{\{}\AgdaBound{MM} \AgdaSymbol{:} \AgdaDatatype{HetsnocList} \AgdaSymbol{(}\AgdaFunction{VExpression} \AgdaBound{V}\AgdaSymbol{)} \AgdaBound{KK}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{xx₀:=} \AgdaBound{MM} \AgdaFunction{•SR} \AgdaFunction{ups} \AgdaBound{KK} \AgdaFunction{∼} \AgdaFunction{idSub} \AgdaBound{V}\<%
\\
...
%
\\
\>\AgdaFunction{botSub-ups} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaBound{KK} \AgdaSymbol{\{}\AgdaBound{C} \AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{MM} \AgdaSymbol{:} \AgdaDatatype{HetsnocList} \AgdaSymbol{(}\AgdaFunction{VExpression} \AgdaBound{V}\AgdaSymbol{)} \AgdaBound{KK}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{E} \AgdaSymbol{:} \AgdaDatatype{Subexp} \AgdaBound{V} \AgdaBound{C} \AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{E} \AgdaFunction{〈} \AgdaFunction{ups} \AgdaBound{KK} \AgdaFunction{〉} \AgdaFunction{⟦} \AgdaFunction{xx₀:=} \AgdaBound{MM} \AgdaFunction{⟧} \AgdaDatatype{≡} \AgdaBound{E}\<%
\\
...
%
\\
\>\AgdaFunction{•-botsub} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U} \AgdaBound{V} \AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{σ} \AgdaSymbol{:} \AgdaFunction{Sub} \AgdaBound{U} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N} \AgdaSymbol{:} \AgdaFunction{VExpression} \AgdaBound{U} \AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{σ} \AgdaFunction{•} \AgdaSymbol{(}\AgdaFunction{x₀:=} \AgdaBound{N}\AgdaSymbol{)} \AgdaFunction{∼} \AgdaFunction{extendSub} \AgdaBound{σ} \AgdaSymbol{(}\AgdaBound{N} \AgdaFunction{⟦} \AgdaBound{σ} \AgdaFunction{⟧}\AgdaSymbol{)}\<%
\\
\>\AgdaFunction{•-botsub} \AgdaInductiveConstructor{x₀} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{•-botsub} \AgdaSymbol{(}\AgdaInductiveConstructor{↑} \AgdaSymbol{\_)} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\end{code}
}
