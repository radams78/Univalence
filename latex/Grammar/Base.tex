...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{dom} \AgdaBound{V} \AgdaSymbol{(}\AgdaBound{K} \AgdaInductiveConstructor{⟶} \AgdaBound{A}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{dom} \AgdaSymbol{(}\AgdaBound{V} \AgdaInductiveConstructor{,} \AgdaBound{K}\AgdaSymbol{)} \AgdaBound{A}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
