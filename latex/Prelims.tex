...
%
\\
\>\AgdaKeyword{module} \AgdaModule{Bifunction} \<[18]%
\>[18]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{(}\AgdaBound{f} \AgdaSymbol{:} \AgdaField{Setoid.Carrier} \AgdaBound{A} \AgdaSymbol{→} \AgdaField{Setoid.Carrier} \AgdaBound{B} \AgdaSymbol{→} \AgdaField{Setoid.Carrier} \AgdaBound{C}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{wd} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a} \AgdaBound{a'} \AgdaBound{b} \AgdaBound{b'}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaField{Setoid.\_≈\_} \AgdaBound{A} \AgdaBound{a} \AgdaBound{a'} \AgdaSymbol{→} \AgdaField{Setoid.\_≈\_} \AgdaBound{B} \AgdaBound{b} \AgdaBound{b'} \AgdaSymbol{→} \AgdaField{Setoid.\_≈\_} \AgdaBound{C} \AgdaSymbol{(}\AgdaBound{f} \AgdaBound{a} \AgdaBound{b}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{f} \AgdaBound{a'} \AgdaBound{b'}\AgdaSymbol{))} \AgdaKeyword{where}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{congl} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a} \AgdaBound{a'} \AgdaBound{b}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaField{Setoid.\_≈\_} \AgdaBound{A} \AgdaBound{a} \AgdaBound{a'} \AgdaSymbol{→} \AgdaField{Setoid.\_≈\_} \AgdaBound{C} \AgdaSymbol{(}\AgdaBound{f} \AgdaBound{a} \AgdaBound{b}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{f} \AgdaBound{a'} \AgdaBound{b}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{congl} \AgdaBound{a≈a'} \AgdaSymbol{=} \AgdaBound{wd} \AgdaBound{a≈a'} \AgdaSymbol{(}\AgdaFunction{Setoid.refl} \AgdaBound{B}\AgdaSymbol{)}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{congr} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a} \AgdaBound{b} \AgdaBound{b'}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaField{Setoid.\_≈\_} \AgdaBound{B} \AgdaBound{b} \AgdaBound{b'} \AgdaSymbol{→} \AgdaField{Setoid.\_≈\_} \AgdaBound{C} \AgdaSymbol{(}\AgdaBound{f} \AgdaBound{a} \AgdaBound{b}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{f} \AgdaBound{a} \AgdaBound{b'}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{congr} \AgdaBound{b≈b'} \AgdaSymbol{=} \AgdaBound{wd} \AgdaSymbol{(}\AgdaFunction{Setoid.refl} \AgdaBound{A}\AgdaSymbol{)} \AgdaBound{b≈b'}\<%
\\
%
\\
