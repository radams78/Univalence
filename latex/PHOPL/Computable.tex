...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{computeP} \AgdaBound{Γ} \AgdaBound{L} \AgdaBound{δ} \AgdaSymbol{→} \AgdaBound{ρ} \AgdaPostulate{∶} \AgdaBound{Γ} \AgdaPostulate{⇒R} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Δ} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{δ} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)}\<%
\\
...
\\
\>[4]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaSymbol{(}\AgdaFunction{cong} \AgdaFunction{decode-Prop} \AgdaSymbol{\{}\AgdaArgument{x} \AgdaSymbol{=} \AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ}\AgdaSymbol{)\}} \AgdaSymbol{(}\AgdaFunction{sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)))} \<[67]%
\>[67]\<%
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Θ} \AgdaBound{x} \AgdaBound{ε}\AgdaSymbol{)} \AgdaSymbol{\{}\AgdaArgument{x} \AgdaSymbol{=} \AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ}\AgdaSymbol{)\}} \AgdaSymbol{(}\AgdaFunction{sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)} \AgdaBound{computeε}\AgdaSymbol{))}\<%
\\
%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaBound{φ} \AgdaDatatype{↠} \AgdaFunction{decode-Prop} \AgdaBound{L} \AgdaSymbol{→} \AgdaBound{φ} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉} \AgdaDatatype{↠} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{≈⟨} \AgdaFunction{sym} \AgdaSymbol{(}\AgdaPostulate{decode-rep} \AgdaBound{L}\AgdaSymbol{)} \AgdaFunction{⟩}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaRecord{E'} \AgdaBound{Γ} \AgdaBound{A} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{ρ} \AgdaPostulate{∶} \AgdaBound{Γ} \AgdaPostulate{⇒R} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaDatatype{valid} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaFunction{compute} \AgdaBound{Δ} \AgdaSymbol{(}\AgdaBound{A} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)}\<%
\\
...
\\
\>[4]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{L}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)} \AgdaBound{computeε}\AgdaSymbol{)))} \AgdaInductiveConstructor{,p} \<[57]%
\>[57]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[4]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{L'}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)} \AgdaBound{computeε}\AgdaSymbol{)))}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaRecord{E'} \AgdaBound{Γ} \AgdaBound{A} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{ρ} \AgdaPostulate{∶} \AgdaBound{Γ} \AgdaPostulate{⇒R} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaDatatype{valid} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaRecord{E'} \AgdaBound{Δ} \AgdaSymbol{(}\AgdaBound{A} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)}\<%
\\
\>\AgdaFunction{E'-rep} \AgdaSymbol{(}\AgdaInductiveConstructor{E'I} \AgdaBound{Γ⊢M∶A} \AgdaBound{computeM}\AgdaSymbol{)} \AgdaBound{ρ∶Γ⇒RΔ} \AgdaBound{validΔ} \AgdaSymbol{=} \AgdaInductiveConstructor{E'I} \AgdaSymbol{(}\AgdaPostulate{weakening} \AgdaBound{Γ⊢M∶A} \AgdaBound{validΔ} \AgdaBound{ρ∶Γ⇒RΔ}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{compute-rep} \AgdaSymbol{(}\AgdaInductiveConstructor{E'I} \AgdaBound{Γ⊢M∶A} \AgdaBound{computeM}\AgdaSymbol{)} \AgdaBound{ρ∶Γ⇒RΔ} \AgdaBound{validΔ}\AgdaSymbol{)}\<%
\\
%
\\
\>\AgdaComment{\{-\<\\
