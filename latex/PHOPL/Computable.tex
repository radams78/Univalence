...
\\
\>\AgdaKeyword{open} \AgdaKeyword{import} \AgdaModule{Data.Product} \AgdaKeyword{hiding} \AgdaSymbol{(}\AgdaFunction{zip}\AgdaSymbol{)} \AgdaKeyword{renaming} \AgdaSymbol{(}\AgdaInductiveConstructor{\_,\_} \AgdaSymbol{to} \AgdaInductiveConstructor{\_,p\_}\AgdaSymbol{)}\<%
\\
\>\AgdaKeyword{open} \AgdaKeyword{import} \AgdaModule{Data.List} \AgdaKeyword{hiding} \AgdaSymbol{(}\AgdaFunction{all}\AgdaSymbol{;}\AgdaFunction{zip}\AgdaSymbol{)}\<%
\\
...
%
\\
\>\AgdaFunction{allE} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaBound{Γ} \AgdaSymbol{:} \AgdaDatatype{Context} \AgdaBound{V}\AgdaSymbol{)} \AgdaSymbol{\{}\AgdaBound{SS}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{ListMeaning} \AgdaBound{V} \AgdaBound{SS} \AgdaSymbol{→} \AgdaFunction{K} \AgdaDatatype{MeaningShape} \AgdaSymbol{(}\AgdaFunction{Proof} \AgdaBound{V}\AgdaSymbol{)} \AgdaBound{SS} \AgdaSymbol{→} \AgdaPrimitiveType{Set}\<%
\\
\>\AgdaFunction{allE} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaBound{Γ} \AgdaSymbol{\{}\AgdaBound{SS}\AgdaSymbol{\}} \AgdaBound{φφ} \AgdaBound{pp} \AgdaSymbol{=} \AgdaDatatype{all} \AgdaSymbol{(λ} \AgdaSymbol{\{}\AgdaBound{φ}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaSymbol{λ} \AgdaSymbol{\{(}\AgdaBound{φ} \AgdaInductiveConstructor{,p} \AgdaBound{δ}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaRecord{E} \AgdaBound{Γ} \AgdaSymbol{(}\AgdaFunction{decode-Meaning} \AgdaBound{φ}\AgdaSymbol{)} \AgdaBound{δ}\AgdaSymbol{\})} \AgdaBound{SS} \AgdaSymbol{(}\AgdaFunction{zip} \AgdaBound{φφ} \AgdaBound{pp}\AgdaSymbol{)}\<%
\end{code}
...
%
\\
\>\AgdaKeyword{postulate} \AgdaPostulate{EPropE} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V} \AgdaBound{S}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Γ} \AgdaSymbol{:} \AgdaDatatype{Context} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{φ} \AgdaSymbol{:} \AgdaDatatype{Meaning} \AgdaBound{V} \AgdaBound{S}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{δ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{εε}\AgdaSymbol{\}} \AgdaSymbol{→}\<%
\\
\>[9]\AgdaIndent{17}{}\<[17]%
\>[17]\AgdaFunction{computeP} \AgdaBound{Γ} \AgdaBound{φ} \AgdaBound{δ} \AgdaSymbol{→} \AgdaFunction{allE} \AgdaBound{Γ} \AgdaSymbol{(}\AgdaFunction{domMeaning} \AgdaBound{φ}\AgdaSymbol{)} \AgdaBound{εε} \AgdaSymbol{→} \AgdaDatatype{SN} \AgdaSymbol{(}\AgdaFunction{APPP'} \AgdaBound{δ} \AgdaSymbol{(}\AgdaFunction{unhet} \AgdaBound{εε}\AgdaSymbol{))}\<%
\\
\>\AgdaComment{\{- EPropE \{φ = nf₀ \_\} \{εε = []\} computeδ [] = computeδ\<\\
...
%
\\
\>\AgdaKeyword{postulate} \AgdaPostulate{EPropI} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Γ} \AgdaSymbol{:} \AgdaDatatype{Context} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{S}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{φ} \AgdaSymbol{:} \AgdaDatatype{Meaning} \AgdaBound{V} \AgdaBound{S}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{δ}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaDatatype{valid} \AgdaBound{Γ} \AgdaSymbol{→}\<%
\\
\>[9]\AgdaIndent{17}{}\<[17]%
\>[17]\AgdaSymbol{(∀} \AgdaSymbol{\{}\AgdaBound{W}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Δ} \AgdaSymbol{:} \AgdaDatatype{Context} \AgdaBound{W}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{ρ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{εε}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{ρ} \AgdaFunction{∶} \AgdaBound{Γ} \AgdaFunction{⇒R} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaDatatype{valid} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaFunction{allE} \AgdaBound{Δ} \AgdaSymbol{(}\AgdaFunction{listnfrep} \AgdaSymbol{(}\AgdaFunction{domMeaning} \AgdaBound{φ}\AgdaSymbol{)} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{εε} \AgdaSymbol{→} \AgdaDatatype{SN} \AgdaSymbol{(}\AgdaFunction{APPP'} \AgdaSymbol{(}\AgdaBound{δ} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{unhet} \AgdaBound{εε}\AgdaSymbol{)))} \AgdaSymbol{→}\<%
\\
\>[9]\AgdaIndent{17}{}\<[17]%
\>[17]\AgdaFunction{computeP} \AgdaBound{Γ} \AgdaBound{φ} \AgdaBound{δ}\<%
\\
\>\AgdaComment{\{- EPropI \{φ = nf₀ N\} validΓ hyp = subst SN rep-idRep (hyp idRep-typed validΓ [])\<\\
...
%
\\
\>\AgdaFunction{E-SNP} \AgdaSymbol{(}\AgdaInductiveConstructor{EI} \AgdaBound{Γ⊢δ∶φ} \AgdaSymbol{(}\AgdaBound{S} \AgdaInductiveConstructor{,p} \AgdaBound{L} \AgdaInductiveConstructor{,p} \AgdaSymbol{\_} \AgdaInductiveConstructor{,p} \AgdaBound{computeδ}\AgdaSymbol{))} \AgdaSymbol{=} \AgdaPostulate{computeP-SN} \AgdaBound{L} \AgdaBound{computeδ} \AgdaSymbol{(}\AgdaFunction{context-validity} \AgdaBound{Γ⊢δ∶φ}\AgdaSymbol{)}\<%
\end{code}
}
\end{proof}
...
\begin{code}%
\>\AgdaFunction{nf-conv-rep} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U} \AgdaBound{V} \AgdaBound{S} \AgdaBound{T}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaBound{φ} \AgdaSymbol{:} \AgdaDatatype{Meaning} \AgdaBound{U} \AgdaBound{S}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{ψ} \AgdaSymbol{:} \AgdaDatatype{Meaning} \AgdaBound{U} \AgdaBound{T}\AgdaSymbol{)} \AgdaSymbol{\{}\AgdaBound{ρ} \AgdaSymbol{:} \AgdaFunction{Rep} \AgdaBound{U} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{decode-Meaning} \AgdaBound{φ} \AgdaFunction{≃} \AgdaFunction{decode-Meaning} \AgdaBound{ψ} \AgdaSymbol{→} \AgdaFunction{decode-Meaning} \AgdaSymbol{(}\AgdaFunction{nfrep} \AgdaBound{φ} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaFunction{≃} \AgdaFunction{decode-Meaning} \AgdaSymbol{(}\AgdaFunction{nfrep} \AgdaBound{ψ} \AgdaBound{ρ}\AgdaSymbol{)}\<%
\\
\>\AgdaFunction{nf-conv-rep} \AgdaSymbol{\{}\AgdaArgument{V} \AgdaSymbol{=} \AgdaBound{V}\AgdaSymbol{\}} \AgdaBound{φ} \AgdaBound{ψ} \AgdaSymbol{\{}\AgdaBound{ρ}\AgdaSymbol{\}} \AgdaBound{φ≃ψ} \AgdaSymbol{=} \AgdaKeyword{let} \AgdaKeyword{open} \AgdaModule{EqReasoning} \AgdaSymbol{(}\AgdaFunction{CONV} \AgdaBound{V} \AgdaInductiveConstructor{-Expression} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term}\AgdaSymbol{))} \AgdaKeyword{in} \<[95]%
\>[95]\<%
\\
\>[0]\AgdaIndent{8}{}\<[8]%
...
\\
\>[8]\AgdaIndent{10}{}\<[10]%
\>[10]\AgdaSymbol{(}\AgdaFunction{decode-Meaning} \AgdaBound{φ}\AgdaSymbol{)} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\<%
\\
\>[0]\AgdaIndent{8}{}\<[8]%
\>[8]\AgdaFunction{≈⟨} \AgdaPostulate{conv-rep} \AgdaBound{φ≃ψ} \AgdaFunction{⟩}\<%
\\
\>[8]\AgdaIndent{10}{}\<[10]%
\>[10]\AgdaSymbol{(}\AgdaFunction{decode-Meaning} \AgdaBound{ψ}\AgdaSymbol{)} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\<%
\\
\>[0]\AgdaIndent{8}{}\<[8]%
\>[8]\AgdaFunction{≡⟨⟨} \AgdaFunction{decode-Meaning-rep} \AgdaBound{ψ} \AgdaFunction{⟩⟩}\<%
\\
\>[8]\AgdaIndent{10}{}\<[10]%
\>[10]\AgdaFunction{decode-Meaning} \AgdaSymbol{(}\AgdaFunction{nfrep} \AgdaBound{ψ} \AgdaBound{ρ}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{8}{}\<[8]%
\>[8]\AgdaFunction{∎}\<%
\\
%
\\
\>\AgdaFunction{nf-weaken} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U} \AgdaBound{V} \AgdaBound{S} \AgdaBound{Γ} \AgdaBound{Δ}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaBound{φ} \AgdaSymbol{:} \AgdaDatatype{Meaning} \AgdaBound{U} \AgdaBound{S}\AgdaSymbol{)} \AgdaSymbol{\{}\AgdaBound{ρ} \AgdaSymbol{:} \AgdaFunction{Rep} \AgdaBound{U} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{Γ} \AgdaDatatype{⊢} \AgdaFunction{decode-Meaning} \AgdaBound{φ} \AgdaDatatype{∶} \AgdaFunction{ty} \AgdaInductiveConstructor{Ω} \AgdaSymbol{→} \AgdaBound{ρ} \AgdaFunction{∶} \AgdaBound{Γ} \AgdaFunction{⇒R} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaDatatype{valid} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaBound{Δ} \AgdaDatatype{⊢} \AgdaFunction{decode-Meaning} \AgdaSymbol{(}\AgdaFunction{nfrep} \AgdaBound{φ} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaDatatype{∶} \AgdaFunction{ty} \AgdaInductiveConstructor{Ω}\<%
\\
\>\AgdaFunction{nf-weaken} \AgdaSymbol{\{}\AgdaBound{U}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{S}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Γ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Δ}\AgdaSymbol{\}} \AgdaBound{φ} \AgdaSymbol{\{}\AgdaBound{ρ}\AgdaSymbol{\}} \AgdaBound{Γ⊢φ∶Ω} \AgdaBound{ρ∶Γ⇒RΔ} \AgdaBound{validΔ} \AgdaSymbol{=} \AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaBound{Δ} \AgdaDatatype{⊢} \AgdaBound{x} \AgdaDatatype{∶} \AgdaFunction{ty} \AgdaInductiveConstructor{Ω}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaSymbol{(}\AgdaFunction{decode-Meaning-rep} \AgdaBound{φ}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaFunction{weakening} \AgdaBound{Γ⊢φ∶Ω} \AgdaBound{validΔ} \AgdaBound{ρ∶Γ⇒RΔ}\AgdaSymbol{)}\<%
\\
%
\\
\>\AgdaFunction{conv-computeP} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V} \AgdaBound{S} \AgdaBound{T}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Γ} \AgdaSymbol{:} \AgdaDatatype{Context} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{L} \AgdaSymbol{:} \AgdaDatatype{Meaning} \AgdaBound{V} \AgdaBound{S}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M} \AgdaSymbol{:} \AgdaDatatype{Meaning} \AgdaBound{V} \AgdaBound{T}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{δ}\AgdaSymbol{\}} \AgdaSymbol{→}\<%
\\
\>[8]\AgdaIndent{16}{}\<[16]%
\>[16]\AgdaFunction{computeP} \AgdaBound{Γ} \AgdaBound{L} \AgdaBound{δ} \AgdaSymbol{→} \AgdaFunction{decode-Meaning} \AgdaBound{L} \AgdaFunction{≃} \AgdaFunction{decode-Meaning} \AgdaBound{M} \AgdaSymbol{→}\<%
\\
\>[8]\AgdaIndent{16}{}\<[16]%
\>[16]\AgdaBound{Γ} \AgdaDatatype{⊢} \AgdaFunction{decode-Meaning} \AgdaBound{L} \AgdaDatatype{∶} \AgdaFunction{ty} \AgdaInductiveConstructor{Ω} \AgdaSymbol{→}\<%
\\
\>[8]\AgdaIndent{16}{}\<[16]%
\>[16]\AgdaBound{Γ} \AgdaDatatype{⊢} \AgdaFunction{decode-Meaning} \AgdaBound{M} \AgdaDatatype{∶} \AgdaFunction{ty} \AgdaInductiveConstructor{Ω} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Γ} \AgdaBound{M} \AgdaBound{δ}\<%
\\
\>\AgdaFunction{conv-computeP} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaInductiveConstructor{nf₀} \AgdaSymbol{\_\}} \AgdaSymbol{\{}\AgdaInductiveConstructor{nf₀} \AgdaSymbol{\_\}} \AgdaBound{SNδ} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{=} \AgdaBound{SNδ}\<%
\\
\>\AgdaFunction{conv-computeP} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaInductiveConstructor{nf₀} \AgdaBound{L}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{φ} \AgdaInductiveConstructor{imp} \AgdaBound{ψ}\AgdaSymbol{\}} \AgdaSymbol{\_} \AgdaBound{L≃φ⊃ψ} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{=} \AgdaFunction{⊥-elim} \AgdaSymbol{(}\AgdaPostulate{not-nf₀-conv-imp} \AgdaSymbol{\{}\AgdaArgument{M} \AgdaSymbol{=} \AgdaBound{L}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{decode-Meaning} \AgdaBound{φ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{decode-Meaning} \AgdaBound{ψ}\AgdaSymbol{\}} \AgdaBound{L≃φ⊃ψ}\AgdaSymbol{)}\<%
\\
\>\AgdaFunction{conv-computeP} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaBound{φ} \AgdaInductiveConstructor{imp} \AgdaBound{ψ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaInductiveConstructor{nf₀} \AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{\_} \AgdaBound{φ⊃ψ≃M} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{=} \AgdaFunction{⊥-elim} \AgdaSymbol{(}\AgdaPostulate{not-nf₀-conv-imp} \AgdaSymbol{\{}\AgdaArgument{M} \AgdaSymbol{=} \AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{decode-Meaning} \AgdaBound{φ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{decode-Meaning} \AgdaBound{ψ}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaInductiveConstructor{RSTClose.sym} \AgdaBound{φ⊃ψ≃M}\AgdaSymbol{))}\<%
\\
\>\AgdaFunction{conv-computeP} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaBound{φ} \AgdaInductiveConstructor{imp} \AgdaBound{ψ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{φ'} \AgdaInductiveConstructor{imp} \AgdaBound{ψ'}\AgdaSymbol{\}} \AgdaBound{computeδ} \AgdaBound{φ⊃ψ≃φ'⊃ψ'} \AgdaSymbol{(}\AgdaInductiveConstructor{⊃R} \AgdaBound{Γ⊢φ∶Ω} \AgdaBound{Γ⊢ψ∶Ω}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaInductiveConstructor{⊃R} \AgdaBound{Γ⊢φ'∶Ω} \AgdaBound{Γ⊢ψ'∶Ω}\AgdaSymbol{)} \AgdaSymbol{\{}\AgdaBound{W}\AgdaSymbol{\}} \AgdaBound{Δ} \AgdaSymbol{\{}\AgdaBound{ρ}\AgdaSymbol{\}} \AgdaBound{ρ∶Γ⇒RΔ} \AgdaBound{Δ⊢ε∶φ'} \AgdaBound{computeε} \AgdaSymbol{=}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{let} \AgdaBound{validΔ} \AgdaSymbol{:} \AgdaDatatype{valid} \AgdaBound{Δ}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaBound{validΔ} \AgdaSymbol{=} \AgdaFunction{context-validity} \AgdaBound{Δ⊢ε∶φ'} \AgdaKeyword{in}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{let} \AgdaBound{φ'ρ≃φρ} \AgdaSymbol{:} \AgdaFunction{decode-Meaning} \AgdaSymbol{(}\AgdaFunction{nfrep} \AgdaBound{φ'} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaFunction{≃} \AgdaFunction{decode-Meaning} \AgdaSymbol{(}\AgdaFunction{nfrep} \AgdaBound{φ} \AgdaBound{ρ}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaBound{φ'ρ≃φρ} \AgdaSymbol{=} \AgdaFunction{nf-conv-rep} \AgdaBound{φ'} \AgdaBound{φ} \AgdaSymbol{(}\AgdaInductiveConstructor{RSTClose.sym} \AgdaSymbol{(}\AgdaPostulate{imp-convl'} \AgdaBound{φ⊃ψ≃φ'⊃ψ'}\AgdaSymbol{))} \AgdaKeyword{in}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{let} \AgdaBound{Δ⊢φρ∶Ω} \AgdaSymbol{:} \AgdaBound{Δ} \AgdaDatatype{⊢} \AgdaFunction{decode-Meaning} \AgdaSymbol{(}\AgdaFunction{nfrep} \AgdaBound{φ} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaDatatype{∶} \AgdaFunction{ty} \AgdaInductiveConstructor{Ω}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaBound{Δ⊢φρ∶Ω} \AgdaSymbol{=} \AgdaFunction{nf-weaken} \AgdaBound{φ} \AgdaBound{Γ⊢φ∶Ω} \AgdaBound{ρ∶Γ⇒RΔ} \AgdaBound{validΔ} \AgdaKeyword{in}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{conv-computeP} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaFunction{nfrep} \AgdaBound{ψ} \AgdaBound{ρ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{nfrep} \AgdaBound{ψ'} \AgdaBound{ρ}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaBound{computeδ} \AgdaBound{Δ} \AgdaBound{ρ∶Γ⇒RΔ} \<[64]%
\>[64]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{(}\AgdaInductiveConstructor{convR} \AgdaBound{Δ⊢ε∶φ'} \AgdaBound{Δ⊢φρ∶Ω} \AgdaBound{φ'ρ≃φρ}\AgdaSymbol{)} \<[31]%
\>[31]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaFunction{conv-computeP} \AgdaBound{computeε} \AgdaBound{φ'ρ≃φρ} \AgdaSymbol{(}\AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaBound{Δ} \AgdaDatatype{⊢} \AgdaBound{x} \AgdaDatatype{∶} \AgdaFunction{ty} \AgdaInductiveConstructor{Ω}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaSymbol{(}\AgdaFunction{decode-Meaning-rep} \AgdaBound{φ'}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaFunction{weakening} \AgdaBound{Γ⊢φ'∶Ω} \AgdaBound{validΔ} \AgdaBound{ρ∶Γ⇒RΔ}\AgdaSymbol{))} \<[135]%
\>[135]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaBound{Δ⊢φρ∶Ω}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaFunction{nf-conv-rep} \AgdaBound{ψ} \AgdaBound{ψ'} \AgdaSymbol{(}\AgdaPostulate{imp-convr'} \AgdaBound{φ⊃ψ≃φ'⊃ψ'}\AgdaSymbol{))} \<[55]%
\>[55]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaFunction{nf-weaken} \AgdaBound{ψ} \AgdaBound{Γ⊢ψ∶Ω} \AgdaBound{ρ∶Γ⇒RΔ} \AgdaBound{validΔ}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{nf-weaken} \AgdaBound{ψ'} \AgdaBound{Γ⊢ψ'∶Ω} \AgdaBound{ρ∶Γ⇒RΔ} \AgdaBound{validΔ}\AgdaSymbol{)}\<%
\end{code}
\item
...
\\
\>\AgdaComment{--E-⊥ validΓ = EI (⊥R validΓ) (nf-SN nf⊥)}\<%
\\
%
\\
