...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{L} \AgdaDatatype{≡} \AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{(}\AgdaBound{ρ∶Γ⇒RΔ} \AgdaSymbol{:} \AgdaBound{ρ} \AgdaFunction{∶} \AgdaBound{Γ} \AgdaFunction{⇒R} \AgdaBound{Δ}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{Δ⊢ε∶φ} \AgdaSymbol{:} \AgdaBound{Δ} \AgdaDatatype{⊢} \AgdaBound{ε} \AgdaDatatype{∶} \AgdaSymbol{(}\AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ}\AgdaSymbol{)))}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaKeyword{let} \AgdaBound{step1a} \AgdaSymbol{:} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ'}\AgdaSymbol{)} \AgdaFunction{≃} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ}\AgdaSymbol{)}\<%
\\
\>[6]\AgdaIndent{10}{}\<[10]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaKeyword{let} \AgdaBound{step5} \AgdaSymbol{:} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{ψ'}\AgdaSymbol{)} \AgdaFunction{≃} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{ψ}\AgdaSymbol{)}\<%
\\
\>[6]\AgdaIndent{10}{}\<[10]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaPostulate{conv-computeP} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{ψ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{M} \AgdaSymbol{=} \AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{ψ'}\AgdaSymbol{\}} \AgdaBound{step4} \AgdaSymbol{(}\AgdaInductiveConstructor{RSTClose.sym} \AgdaBound{step5}\AgdaSymbol{)} \AgdaBound{step6}\AgdaSymbol{)} \AgdaInductiveConstructor{,p} \<[88]%
\>[88]\<%
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(} \<[9]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaKeyword{let} \AgdaBound{step1a} \AgdaSymbol{:} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{ψ'}\AgdaSymbol{)} \AgdaFunction{≃} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{ψ}\AgdaSymbol{)}\<%
\\
\>[6]\AgdaIndent{10}{}\<[10]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaKeyword{let} \AgdaBound{step5} \AgdaSymbol{:} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ'}\AgdaSymbol{)} \AgdaFunction{≃} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ}\AgdaSymbol{)}\<%
\\
\>[6]\AgdaIndent{10}{}\<[10]%
\>[10]\AgdaBound{step5} \AgdaSymbol{=} \AgdaFunction{subst₂} \AgdaFunction{\_≃\_} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaSymbol{(}\AgdaFunction{Prelims.trans} \AgdaSymbol{(}\AgdaPostulate{decode-rep} \AgdaBound{φ'}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{rep-congl} \AgdaBound{φ'≡Q}\AgdaSymbol{)))} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaSymbol{(}\AgdaPostulate{decode-rep} \AgdaBound{φ}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaPostulate{conv-rep} \AgdaSymbol{\{}\AgdaArgument{M} \AgdaSymbol{=} \AgdaBound{Q}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{N} \AgdaSymbol{=} \AgdaFunction{decode-Prop} \AgdaBound{φ}\AgdaSymbol{\}} \<[159]%
\>[159]\<%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaPostulate{conv-computeP} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{M} \AgdaSymbol{=} \AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ'}\AgdaSymbol{\}} \AgdaBound{step4} \AgdaSymbol{(}\AgdaInductiveConstructor{RSTClose.sym} \AgdaBound{step5}\AgdaSymbol{)} \AgdaBound{step6}\AgdaSymbol{))}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{computeP} \AgdaBound{Γ} \AgdaBound{L} \AgdaBound{δ} \AgdaSymbol{→} \AgdaBound{ρ} \AgdaFunction{∶} \AgdaBound{Γ} \AgdaFunction{⇒R} \AgdaBound{Δ} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Δ} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{δ} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)}\<%
\\
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{ψ}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{≡⟨} \AgdaFunction{lrep-comp} \AgdaFunction{⟩}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{ψ}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[4]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaSymbol{(}\AgdaFunction{cong} \AgdaFunction{decode-Prop} \AgdaSymbol{\{}\AgdaArgument{x} \AgdaSymbol{=} \AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ}\AgdaSymbol{)\}} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)))} \<[75]%
\>[75]\<%
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Θ} \AgdaBound{x} \AgdaBound{ε}\AgdaSymbol{)} \AgdaSymbol{\{}\AgdaArgument{x} \AgdaSymbol{=} \AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{φ}\AgdaSymbol{)\}} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)} \AgdaBound{computeε}\AgdaSymbol{))}\<%
\\
%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaBound{φ} \AgdaFunction{↠} \AgdaFunction{decode-Prop} \AgdaBound{L} \AgdaSymbol{→} \AgdaBound{φ} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉} \AgdaFunction{↠} \AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)}\<%
\\
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{decode-Prop} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{∎}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaBound{S} \AgdaInductiveConstructor{,p} \AgdaBound{S'} \AgdaInductiveConstructor{,p} \AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L} \AgdaInductiveConstructor{,p} \AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L'} \AgdaInductiveConstructor{,p} \<[38]%
\>[38]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{red-decode-rep} \AgdaBound{L} \AgdaBound{φ↠L} \AgdaInductiveConstructor{,p}\<%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{(λ} \AgdaBound{Θ} \AgdaSymbol{\{}\AgdaBound{ρ'}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{ε}\AgdaSymbol{\}} \AgdaBound{ρ'∶Δ⇒RΘ} \AgdaBound{Θ⊢ε∶Lρρ'} \AgdaBound{computeε} \AgdaSymbol{→} \AgdaFunction{subst₂} \AgdaSymbol{(λ} \AgdaBound{a} \AgdaBound{b} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Θ} \AgdaBound{a} \AgdaSymbol{(}\AgdaFunction{appP} \AgdaSymbol{(}\AgdaFunction{plus} \AgdaBound{b}\AgdaSymbol{)} \AgdaBound{ε}\AgdaSymbol{))} \AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{L'}\AgdaSymbol{\}}\<%
\\
\>[2]\AgdaIndent{46}{}\<[46]%
\>[46]\AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L'}\AgdaSymbol{)\}} \AgdaSymbol{\{}\AgdaBound{P} \AgdaFunction{〈} \AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{\}} \AgdaSymbol{\{(}\AgdaBound{P} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)} \AgdaFunction{〈} \AgdaBound{ρ'} \AgdaFunction{〉}\AgdaSymbol{\}} \<[103]%
\>[103]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaPostulate{change-type} \AgdaBound{Θ⊢ε∶Lρρ'} \AgdaSymbol{(}\AgdaFunction{cong} \AgdaFunction{decode-Prop} \AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)\}} \AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{L}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)))} \<[110]%
\>[110]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{a} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Θ} \AgdaBound{a} \AgdaBound{ε}\AgdaSymbol{)} \AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)\}}\<%
\\
\>[4]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{L}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)} \AgdaBound{computeε}\AgdaSymbol{)))} \AgdaInductiveConstructor{,p} \<[65]%
\>[65]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{(λ} \AgdaBound{Θ} \AgdaSymbol{\{}\AgdaBound{ρ'}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{ε}\AgdaSymbol{\}} \AgdaBound{ρ'∶Δ⇒RΘ} \AgdaBound{Θ⊢ε∶L'ρρ'} \AgdaBound{computeε} \AgdaSymbol{→} \AgdaFunction{subst₂} \AgdaSymbol{(λ} \AgdaBound{a} \AgdaBound{b} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Θ} \AgdaBound{a} \AgdaSymbol{(}\AgdaFunction{appP} \AgdaSymbol{(}\AgdaFunction{minus} \AgdaBound{b}\AgdaSymbol{)} \AgdaBound{ε}\AgdaSymbol{))} \AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{L}\AgdaSymbol{\}}\<%
\\
\>[2]\AgdaIndent{46}{}\<[46]%
\>[46]\AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L}\AgdaSymbol{)\}} \AgdaSymbol{\{}\AgdaBound{P} \AgdaFunction{〈} \AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{\}} \AgdaSymbol{\{(}\AgdaBound{P} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\AgdaSymbol{)} \AgdaFunction{〈} \AgdaBound{ρ'} \AgdaFunction{〉}\AgdaSymbol{\}} \<[102]%
\>[102]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lrep-comp} \AgdaSymbol{(}\AgdaFunction{rep-comp} \AgdaBound{P}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{computeP-} \AgdaBound{Θ} \AgdaSymbol{(}\AgdaPostulate{compR-typed} \AgdaBound{ρ'∶Δ⇒RΘ} \AgdaBound{ρ∶Γ⇒RΔ}\AgdaSymbol{)} \<[67]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaPostulate{change-type} \AgdaBound{Θ⊢ε∶L'ρρ'} \AgdaSymbol{(}\AgdaFunction{cong} \AgdaFunction{decode-Prop} \AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L'}\AgdaSymbol{)\}} \AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaSymbol{(}\AgdaBound{ρ'} \AgdaFunction{•R} \AgdaBound{ρ}\AgdaSymbol{)} \AgdaBound{L'}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaFunction{lrep-comp}\AgdaSymbol{)))} \<[113]%
\>[113]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{a} \AgdaSymbol{→} \AgdaFunction{computeP} \AgdaBound{Θ} \AgdaBound{a} \AgdaBound{ε}\AgdaSymbol{)} \AgdaSymbol{\{}\AgdaFunction{lrep} \AgdaBound{ρ'} \AgdaSymbol{(}\AgdaFunction{lrep} \AgdaBound{ρ} \AgdaBound{L'}\AgdaSymbol{)\}}\<%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{(}\AgdaBound{computeP} \AgdaBound{Θ} \AgdaSymbol{(}\AgdaPostulate{compR-typed} \AgdaBound{ρ'∶Δ⇒RΘ} \AgdaBound{ρ∶Γ⇒RΔ}\AgdaSymbol{)} \AgdaBound{Θ⊢Q∶N≡N'} \AgdaBound{computeQ}\AgdaSymbol{)}\<%
\\
%
\\
