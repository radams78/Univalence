...
\\
\>\AgdaFunction{APP*-typed} \AgdaSymbol{\{}\AgdaArgument{MM} \AgdaSymbol{=} \AgdaBound{M} \AgdaInductiveConstructor{∷} \AgdaBound{MM}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{NN} \AgdaSymbol{=} \AgdaBound{N} \AgdaInductiveConstructor{∷} \AgdaBound{NN}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{QQ} \AgdaSymbol{=} \AgdaBound{Q} \AgdaInductiveConstructor{∷} \AgdaBound{QQ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{AA} \AgdaSymbol{=} \AgdaBound{A} \AgdaInductiveConstructor{∷} \AgdaBound{AA}\AgdaSymbol{\}} \AgdaBound{Γ⊢P∶M≡N} \AgdaBound{Γ⊢QQ∶MM≡NN} \AgdaSymbol{=} \<[88]%
\>[88]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{APP*-typed} \AgdaSymbol{\{}\AgdaArgument{MM} \AgdaSymbol{=} \AgdaBound{MM}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{NN} \AgdaSymbol{=} \AgdaBound{NN}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{QQ} \AgdaSymbol{=} \AgdaBound{QQ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaArgument{AA} \AgdaSymbol{=} \AgdaBound{AA}\AgdaSymbol{\}} \<[53]%
\>[53]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{(}\AgdaInductiveConstructor{app*R} \AgdaSymbol{(}\AgdaPostulate{equation-validity₁} \AgdaSymbol{(}\AgdaBound{Γ⊢QQ∶MM≡NN} \AgdaInductiveConstructor{zero}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaPostulate{equation-validity₂} \AgdaSymbol{(}\AgdaBound{Γ⊢QQ∶MM≡NN} \AgdaInductiveConstructor{zero}\AgdaSymbol{))} \<[87]%
\>[87]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaBound{Γ⊢P∶M≡N} \AgdaSymbol{(}\AgdaBound{Γ⊢QQ∶MM≡NN} \AgdaInductiveConstructor{zero}\AgdaSymbol{))} \AgdaSymbol{(λ} \AgdaBound{i} \AgdaSymbol{→} \AgdaBound{Γ⊢QQ∶MM≡NN} \AgdaSymbol{(}\AgdaInductiveConstructor{suc} \AgdaBound{i}\AgdaSymbol{))}\<%
\end{code}
