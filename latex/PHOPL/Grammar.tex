...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{data} \AgdaDatatype{PHOPLcon} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{K} \AgdaSymbol{:} \AgdaDatatype{ExpressionKind}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{Kind} \AgdaSymbol{(}\AgdaInductiveConstructor{-Constructor} \AgdaBound{K}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaPrimitiveType{Set} \AgdaKeyword{where}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-ty} \AgdaSymbol{:} \AgdaDatatype{Type} \AgdaSymbol{→} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{nonVarKind} \AgdaInductiveConstructor{-Type} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-appProof} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-lamProof} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaSymbol{(}\AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{abs} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{✧}\AgdaSymbol{)} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-bot} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-imp} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{●}\AgdaSymbol{)} \<[74]%
\>[74]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-appTerm} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-lamTerm} \AgdaSymbol{:} \AgdaDatatype{Type} \AgdaSymbol{→} \AgdaDatatype{PHOPLcon} \AgdaSymbol{((}\AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{abs} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧}\AgdaSymbol{)} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-ref} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-imp*} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-univ} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-lll} \AgdaSymbol{:} \AgdaDatatype{Type} \AgdaSymbol{→} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{abs} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{abs} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{abs} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-app*} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-plus} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-minus} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-eq} \AgdaSymbol{:} \AgdaDatatype{Type} \AgdaSymbol{→} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{✧} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{nonVarKind} \AgdaInductiveConstructor{-Equation} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
