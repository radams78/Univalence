...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-appProof} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-lamProof} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaSymbol{(}\AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaFunction{♣}\AgdaSymbol{)} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-imp} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{●}\AgdaSymbol{)} \<[74]%
\>[74]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-appTerm} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-lamTerm} \AgdaSymbol{:} \AgdaDatatype{Type} \AgdaSymbol{→} \AgdaDatatype{PHOPLcon} \AgdaSymbol{((}\AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣}\AgdaSymbol{)} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-ref} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-imp*} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-univ} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-lll} \AgdaSymbol{:} \AgdaDatatype{Type} \AgdaSymbol{→} \AgdaDatatype{PHOPLcon} \AgdaSymbol{((}\AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{-Term} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaFunction{♣}\AgdaSymbol{)} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-app*} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-plus} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-minus} \AgdaSymbol{:} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Path} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Proof} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaInductiveConstructor{-eq} \AgdaSymbol{:} \AgdaDatatype{Type} \AgdaSymbol{→} \AgdaDatatype{PHOPLcon} \AgdaSymbol{(}\AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{varKind} \AgdaInductiveConstructor{-Term} \AgdaFunction{♣} \AgdaInductiveConstructor{⟶} \AgdaInductiveConstructor{nonVarKind} \AgdaInductiveConstructor{-Equation} \AgdaInductiveConstructor{●}\AgdaSymbol{)}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
