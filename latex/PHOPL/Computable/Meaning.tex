...
%
\\
\>\AgdaFunction{SNOCLISTF} \AgdaSymbol{:} \AgdaRecord{SetFunctor} \AgdaSymbol{→} \AgdaRecord{SetFunctor}\<%
\\
\>\AgdaFunction{SNOCLISTF} \AgdaBound{F} \AgdaSymbol{=} \AgdaKeyword{record} \AgdaSymbol{\{} \<[23]%
\>[23]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\begin{code}%
\>\AgdaKeyword{postulate} \AgdaPostulate{not-nf₀-conv-imp} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M} \AgdaSymbol{:} \AgdaDatatype{Meaning₀} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{φ} \AgdaBound{ψ} \AgdaSymbol{:} \AgdaFunction{Term} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{decode-Meaning₀} \AgdaBound{M} \AgdaFunction{≃} \AgdaBound{φ} \AgdaFunction{⊃} \AgdaBound{ψ} \AgdaSymbol{→} \AgdaDatatype{Empty}\<%
\\
%
\\
...
%
\\
\>\AgdaFunction{not-⊃MMM-typed} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Γ} \AgdaSymbol{:} \AgdaDatatype{Context} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{φ} \AgdaBound{ψ}\AgdaSymbol{\}} \AgdaBound{MM} \AgdaSymbol{\{}\AgdaBound{N} \AgdaBound{A}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{Γ} \AgdaDatatype{⊢} \AgdaFunction{appT} \AgdaSymbol{(}\AgdaFunction{APPl} \AgdaSymbol{(}\AgdaBound{φ} \AgdaFunction{⊃} \AgdaBound{ψ}\AgdaSymbol{)} \AgdaBound{MM}\AgdaSymbol{)} \AgdaBound{N} \AgdaDatatype{∶} \AgdaBound{A} \AgdaSymbol{→} \AgdaDatatype{Empty}\<%
\\
\>\AgdaFunction{not-⊃MMM-typed} \AgdaInductiveConstructor{[]} \AgdaSymbol{(}\AgdaInductiveConstructor{appR} \AgdaSymbol{()} \AgdaSymbol{\_)}\<%
\\
\>\AgdaFunction{not-⊃MMM-typed} \AgdaSymbol{(}\AgdaBound{MM} \AgdaInductiveConstructor{snoc} \AgdaBound{M}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaInductiveConstructor{appR} \AgdaBound{Γ⊢MMM∶A⇛B} \AgdaBound{Γ⊢N∶A}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{not-⊃MMM-typed} \AgdaBound{MM} \AgdaBound{Γ⊢MMM∶A⇛B}\<%
\end{code}
