...
\>\AgdaKeyword{open} \AgdaKeyword{import} \AgdaModule{Reduction} \AgdaFunction{PHOPL} \AgdaDatatype{R} \AgdaSymbol{as} \AgdaModule{Red}\<%
\\
\>\AgdaKeyword{open} \AgdaKeyword{import} \AgdaModule{Reduction.Subred} \AgdaFunction{PHOPL}\<%
\end{code}
}
...
\\
\>\AgdaFunction{R₀-imp-R} \AgdaSymbol{=} \AgdaFunction{Subred.sub-osr} \AgdaDatatype{R₀} \AgdaDatatype{R} \AgdaInductiveConstructor{R₀R}\<%
\\
%
\\
...
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{βR} \AgdaInductiveConstructor{βT}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{())}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{())} \AgdaSymbol{(}\AgdaInductiveConstructor{βR} \AgdaInductiveConstructor{βT}\AgdaSymbol{)}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{βR} \AgdaInductiveConstructor{βT}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaInductiveConstructor{βR} \AgdaInductiveConstructor{βT}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{βR} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{βR} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{dir-ref} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{dir-ref} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{plus-univ} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{plus-univ} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{minus-univ} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{minus-univ} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{ref⊃*univ} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{ref⊃*univ} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{univ⊃*ref} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{univ⊃*ref} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{univ⊃*univ} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{univ⊃*univ} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{ref⊃*ref} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{ref⊃*ref} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{refref} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{refref} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{refref} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{reflam} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{()))}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{βE} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{βE} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{reflam} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{reflam} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_))} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaFunction{R-det} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{reflam} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{\_} \AgdaSymbol{()))} \AgdaSymbol{(}\AgdaInductiveConstructor{R₀R} \AgdaSymbol{(}\AgdaInductiveConstructor{refref} \AgdaSymbol{\_} \AgdaSymbol{\_))}\<%
\end{code}
...
%
\\
\>\AgdaKeyword{postulate} \AgdaPostulate{R-respects-rep} \AgdaSymbol{:} \AgdaFunction{Red.respects'} \AgdaFunction{REP}\<%
\\
%
\\
...
%
\\
\>\AgdaKeyword{postulate} \AgdaPostulate{conv-rep} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U} \AgdaBound{V} \AgdaBound{C} \AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{E} \AgdaBound{E'} \AgdaSymbol{:} \AgdaDatatype{Subexp} \AgdaBound{U} \AgdaBound{C} \AgdaBound{K}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{ρ} \AgdaSymbol{:} \AgdaFunction{Rep} \AgdaBound{U} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{E} \AgdaFunction{Red.≃} \AgdaBound{E'} \AgdaSymbol{→} \AgdaBound{E} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉} \AgdaFunction{Red.≃} \AgdaBound{E'} \AgdaFunction{〈} \AgdaBound{ρ} \AgdaFunction{〉}\<%
\\
%
\\
...
\begin{code}%
\>[18]\AgdaIndent{20}{}\<[20]%
\>[20]\AgdaBound{E} \AgdaDatatype{Red.⇒} \AgdaBound{F} \AgdaSymbol{→} \AgdaBound{E} \AgdaFunction{⟦} \AgdaBound{σ} \AgdaFunction{⟧} \AgdaDatatype{Red.⇒} \AgdaBound{F} \AgdaFunction{⟦} \AgdaBound{σ} \AgdaFunction{⟧}\<%
\end{code}
%</osr-subl>
...
%
\\
\>\AgdaKeyword{postulate} \AgdaPostulate{appT-red} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M} \AgdaBound{M'} \AgdaBound{N} \AgdaBound{N'} \AgdaSymbol{:} \AgdaFunction{Term} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{M} \AgdaFunction{Red.↠} \AgdaBound{M'} \AgdaSymbol{→} \AgdaBound{N} \AgdaFunction{Red.↠} \AgdaBound{N'} \AgdaSymbol{→} \AgdaFunction{appT} \AgdaBound{M} \AgdaBound{N} \AgdaFunction{Red.↠} \AgdaFunction{appT} \AgdaBound{M'} \AgdaBound{N'}\<%
\\
%
\\
...
%
\\
\>\AgdaFunction{nf-SN} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M} \AgdaSymbol{:} \AgdaFunction{Term} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaDatatype{nf} \AgdaBound{M} \AgdaSymbol{→} \AgdaDatatype{Red.SN} \AgdaBound{M}\<%
\\
\>\AgdaFunction{nf-SN} \AgdaBound{nfM} \AgdaSymbol{=} \AgdaInductiveConstructor{Red.SNI} \AgdaSymbol{\_} \AgdaSymbol{(λ} \AgdaBound{M'} \AgdaBound{M⇒M'} \AgdaSymbol{→} \AgdaFunction{⊥-elim} \AgdaSymbol{(}\AgdaPostulate{nf-is-nf} \AgdaBound{nfM} \AgdaBound{M⇒M'}\AgdaSymbol{))}\<%
\\
%
\\
\>\AgdaFunction{βsub} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{U} \AgdaBound{V} \AgdaBound{A}\AgdaSymbol{\}} \AgdaBound{M} \AgdaSymbol{\{}\AgdaBound{σ} \AgdaSymbol{:} \AgdaFunction{Sub} \AgdaBound{U} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{appT} \AgdaSymbol{(}\AgdaFunction{ΛT} \AgdaBound{A} \AgdaBound{M} \AgdaFunction{⟦} \AgdaBound{σ} \AgdaFunction{⟧}\AgdaSymbol{)} \AgdaBound{N} \AgdaDatatype{Red.⇒} \AgdaBound{M} \AgdaFunction{⟦} \AgdaFunction{extendSub} \AgdaBound{σ} \AgdaBound{N} \AgdaFunction{⟧}\<%
\\
\>\AgdaFunction{βsub} \AgdaSymbol{\{}\AgdaBound{U}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{A}\AgdaSymbol{\}} \AgdaBound{M} \AgdaSymbol{\{}\AgdaBound{σ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{=} \AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaFunction{appT} \AgdaSymbol{(}\AgdaFunction{ΛT} \AgdaBound{A} \AgdaBound{M} \AgdaFunction{⟦} \AgdaBound{σ} \AgdaFunction{⟧}\AgdaSymbol{)} \AgdaBound{N} \AgdaDatatype{Red.⇒} \AgdaBound{x}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{Prelims.sym} \AgdaSymbol{(}\AgdaFunction{extendSub-decomp} \AgdaBound{M}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaInductiveConstructor{Red.redex} \AgdaSymbol{(}\AgdaInductiveConstructor{βR} \AgdaInductiveConstructor{βT}\AgdaSymbol{))}\<%
\end{code}
}
