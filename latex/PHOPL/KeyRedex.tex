...
\\
\>[2]\AgdaIndent{30}{}\<[30]%
\>[30]\AgdaDatatype{key-redex} \AgdaBound{M} \AgdaBound{N} \AgdaSymbol{→} \AgdaBound{M} \AgdaDatatype{⇒} \AgdaBound{P} \AgdaSymbol{→} \AgdaFunction{Σ[} \AgdaBound{Q} \AgdaFunction{∈} \AgdaFunction{Expression} \AgdaBound{V} \AgdaBound{K} \AgdaFunction{]} \AgdaSymbol{(}\AgdaDatatype{key-redex} \AgdaBound{P} \AgdaBound{Q} \AgdaDatatype{⊎} \AgdaBound{P} \AgdaDatatype{≡} \AgdaBound{Q}\AgdaSymbol{)} \AgdaFunction{×} \AgdaBound{N} \AgdaDatatype{↠} \AgdaBound{Q}\<%
\end{code}
