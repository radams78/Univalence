...
\begin{code}%
\>\AgdaKeyword{postulate} \AgdaPostulate{wteE'} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{Γ} \AgdaSymbol{:} \AgdaDatatype{Context} \AgdaBound{V}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{A} \AgdaBound{M} \AgdaBound{B} \AgdaBound{N} \AgdaBound{N'} \AgdaBound{P}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{Γ} \AgdaFunction{,T} \AgdaBound{A} \AgdaDatatype{⊢} \AgdaBound{M} \AgdaDatatype{∶} \AgdaFunction{ty} \AgdaBound{B} \AgdaSymbol{→} \AgdaRecord{E} \AgdaBound{Γ} \AgdaSymbol{(}\AgdaFunction{ty} \AgdaBound{A}\AgdaSymbol{)} \AgdaBound{N} \AgdaSymbol{→} \AgdaRecord{E} \AgdaBound{Γ} \AgdaSymbol{(}\AgdaFunction{ty} \AgdaBound{A}\AgdaSymbol{)} \AgdaBound{N'} \AgdaSymbol{→} \AgdaRecord{E} \AgdaBound{Γ} \AgdaSymbol{(}\AgdaBound{N} \AgdaFunction{≡〈} \AgdaBound{A} \AgdaFunction{〉} \AgdaBound{N'}\AgdaSymbol{)} \AgdaBound{P} \AgdaSymbol{→}\<%
\\
\>[15]\AgdaIndent{16}{}\<[16]%
\>[16]\AgdaRecord{E} \AgdaBound{Γ} \AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{⟦} \AgdaFunction{x₀:=} \AgdaBound{N} \AgdaFunction{⟧} \AgdaFunction{≡〈} \AgdaBound{B} \AgdaFunction{〉} \AgdaBound{M} \AgdaFunction{⟦} \AgdaFunction{x₀:=} \AgdaBound{N'} \AgdaFunction{⟧}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{⟦⟦} \AgdaSymbol{(}\AgdaFunction{x₀::=} \AgdaBound{P}\AgdaSymbol{)} \AgdaFunction{∶} \AgdaSymbol{(}\AgdaFunction{x₀:=} \AgdaBound{N}\AgdaSymbol{)} \AgdaFunction{∼} \AgdaSymbol{(}\AgdaFunction{x₀:=} \AgdaBound{N'}\AgdaSymbol{)} \AgdaFunction{⟧⟧}\AgdaSymbol{)} \AgdaSymbol{→}\<%
\\
\>[15]\AgdaIndent{16}{}\<[16]%
\>[16]\AgdaRecord{E} \AgdaBound{Γ} \AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{⟦} \AgdaFunction{x₀:=} \AgdaBound{N} \AgdaFunction{⟧} \AgdaFunction{≡〈} \AgdaBound{B} \AgdaFunction{〉} \AgdaBound{M} \AgdaFunction{⟦} \AgdaFunction{x₀:=} \AgdaBound{N'} \AgdaFunction{⟧}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{app*} \AgdaBound{N} \AgdaBound{N'} \AgdaSymbol{(}\AgdaFunction{reff} \AgdaSymbol{(}\AgdaFunction{ΛT} \AgdaBound{A} \AgdaBound{M}\AgdaSymbol{))} \AgdaBound{P}\AgdaSymbol{)}\<%
\end{code}
\end{enumerate}
\end{lemma}
