...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lmSNE} \AgdaBound{MM} \AgdaBound{εε} \AgdaSymbol{(}\AgdaPostulate{computeP-SN} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaInductiveConstructor{nf₀} \AgdaSymbol{(}\AgdaInductiveConstructor{neutral} \AgdaBound{x}\AgdaSymbol{)\}} \AgdaBound{computePRRεε} \AgdaBound{validΓ}\AgdaSymbol{)} \AgdaBound{SNL} \AgdaBound{SNL'} \AgdaBound{SNQ}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lmSNE} \AgdaBound{MM} \AgdaBound{εε} \AgdaSymbol{(}\AgdaPostulate{computeP-SN} \AgdaSymbol{\{}\AgdaArgument{L} \AgdaSymbol{=} \AgdaInductiveConstructor{nf₀} \AgdaInductiveConstructor{bot}\AgdaSymbol{\}} \AgdaBound{computePRRεε} \AgdaBound{validΓ}\AgdaSymbol{)} \AgdaBound{SNL} \AgdaBound{SNL'} \AgdaBound{SNQ}\<%
\\
