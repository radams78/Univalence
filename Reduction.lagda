...
\begin{code}
  Reduction : Set₁
  Reduction = ∀ {V} {K} {C : Kind (-Constructor K)} → Constructor C → Expression' V (-Constructor K) C → Expression'' V K → Set

  data osr' (R : Reduction) : ∀ {V} {C} {K} → Expression' V C K → Expression' V C K → Set where
    redex : ∀ {V} {K} {C : Kind (-Constructor K)} {c : Constructor C} {EE : Expression' V (-Constructor K) C} {F : Expression'' V K} → R c EE F → osr' R (app c EE) F
    app : ∀ {V} {K} {C : Kind (-Constructor K)} {c : Constructor C} {MM NN : Expression' V (-Constructor K) C} → osr' R MM NN → osr' R (app c MM) (app c NN)
    appl : ∀ {V} {K} {L} {C : Kind (-Constructor L)} {M N : Expression' V -Abstraction K} {PP : Expression' V (-Constructor L) C} → osr' R M N → osr' R (app₂ M PP) (app₂ N PP)
    appr : ∀ {V} {K} {L} {C : Kind (-Constructor L)} {M : Expression' V -Abstraction K} {NN PP : Expression' V (-Constructor L) C} → osr' R NN PP → osr' R (app₂ M NN) (app₂ M PP)
  ...
  mutual
    data osr (R : Reduction) : ∀ {V} {K} → Expression'' V K → Expression'' V K → Set where
      redex : ∀ {V} {K} {C : Kind (-Constructor K)} {c : Constructor C} {EE : Expression' V (-Constructor K) C} {F : Expression'' V K} → R c EE F → osr R (app c EE) F
      app : ∀ {V} {K} {C : Kind (-Constructor K)} {c : Constructor C} {MM NN : Expression' V (-Constructor K) C} → osrB R MM NN → osr R (app c MM) (app c NN)

    data osrB (R : Reduction) : ∀ {V} {K} {C : Kind (-Constructor K)} → Expression' V (-Constructor K) C → Expression' V (-Constructor K) C → Set where
      appl : ∀ {V} {K} {L} {C : Kind (-Constructor L)} {M N : Expression' V -Abstraction K} {PP : Expression' V (-Constructor L) C} → osrA R M N → osrB R (app₂ M PP) (app₂ N PP)
      appr : ∀ {V} {K} {L} {C : Kind (-Constructor L)} {M : Expression' V -Abstraction K} {NN PP : Expression' V (-Constructor L) C} → osrB R NN PP → osrB R (app₂ M NN) (app₂ M PP)
  ...
  data redB (R : Reduction) {V} {K} {C : Kind (-Constructor K)} : Expression' V (-Constructor K) C → Expression' V (-Constructor K) C → Set where
    osr-red : ∀ {M} {N} → osr' R M N → redB R M N
    ref : ∀ {M} → redB R M M
    trans-red : ∀ {M N P : Expression' V (-Constructor K) C} → redB R M N → redB R N P → redB R M P

  redapp : ∀ {R : Reduction} {V} {K} {C : Kind (-Constructor K)} (c : Constructor C) {MM NN : Expression' V (-Constructor K) C} →
  ...
  redappr : ∀ {R : Reduction} {V} {K} {L} {C : Kind (-Constructor L)} {A : Expression' V -Abstraction K} {EE FF : Expression' V (-Constructor L) C} →
  ...
  redappl : ∀ {R : Reduction} {V} {K} {L} {C : Kind (-Constructor L)} {A B : Expression' V -Abstraction K} {EE : Expression' V (-Constructor L) C} →
...
\begin{code}
  ...
  mutual
    ...
    reposrB : ∀ {R : Reduction} → respect-rep R →
      ∀ {U} {V} {K} {C : Kind (-Constructor K)} {M N : Expression' U (-Constructor K) C} {ρ : Rep U V} → osr' R M N → osr' R (rep M ρ) (rep N ρ)
  ...
  mutual
    ...
    subosrB : ∀ {R : Reduction} → respect-sub R →
      ∀ {U} {V} {K} {C : Kind (-Constructor K)} {M N : Expression' U (-Constructor K) C} {ρ : Sub U V} → osr' R M N → osr' R (M ⟦ ρ ⟧B) (N ⟦ ρ ⟧B)
...
\begin{code}
  ...
  mutual
    ...
    subredrB : ∀ {U} {V} {K} {C : Kind (-Constructor K)} {ρ σ : Sub U V} {R : Reduction} {EE : Expression' U (-Constructor K) C} →
      respect-rep R →
...
\begin{code}
  ...
  data SNB (R : Reduction) {V} {K} {C : Kind (-Constructor K)} : Expression' V (-Constructor K) C → Set where
...
\begin{code}
  SNsubexp : ∀ {V} {K} {C : Kind (-Constructor K)} {c : Constructor C} {EE : Expression' V (-Constructor K) C} {R : Reduction} → SN R (app c EE) → SNB R EE
  ...
  SNsubbodyl : ∀ {V} {K} {L} {C : Kind (-Constructor K)} {A : Expression' V -Abstraction L} {EE : Expression' V (-Constructor K) C} {R : Reduction} →
    SNB R (app₂ A EE) → SNA R A
  SNsubbodyl {A = A} {EE = EE} (SNI .(app₂ A EE) SNAEE) = SNI A (λ B A↠B → SNsubbodyl (SNAEE (app₂ B EE) (appl A↠B)))

  SNsubbodyr : ∀ {V} {K} {L} {C : Kind (-Constructor K)} {A : Expression' V -Abstraction L} {EE : Expression' V (-Constructor K) C} {R : Reduction} →
