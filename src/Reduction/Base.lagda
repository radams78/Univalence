...
\begin{code}
Rewrite : Set₁
Rewrite = ∀ {V C K} → Relation (Subexp V C K)
...
red-conv (inc M⇒N) = inc M⇒N
red-conv ref = ref
red-conv (trans M↠N N↠P) = RSTClose.trans (red-conv M↠N) (red-conv N↠P)

convl : ∀ {V} {A} {AA} {E E' : Abs V A} {FF : ListAbs V AA} → 
  E ≃ E' → (_∷_ {V} {A} {AA} E FF) ≃ (E' ∷ FF)
convl (inc x) = inc (appl x)
convl ref = ref
convl (sym E≃E') = RSTClose.sym (convl E≃E')
convl (trans E≃E' E'≃E'') = RSTClose.trans (convl E≃E') (convl E'≃E'')
