...
module PHOPLgrammar where
  ...
  data PHOPLcon : ∀ {K : ExpressionKind} → 
    ...
    -appProof : PHOPLcon (Π (out (varKind -Proof)) 
      (Π (out (varKind -Proof)) (out (varKind -Proof))))
    -lamProof : PHOPLcon (Π (out (varKind -Term))
      (Π (Π -Proof (out (varKind -Proof))) (out (varKind -Proof))))
    -bot : PHOPLcon (out (varKind -Term))
    -imp : PHOPLcon (Π (out (varKind -Term)) (Π (out (varKind -Term)) (out (varKind -Term))))
    -appTerm : PHOPLcon (Π (out (varKind -Term)) (Π (out (varKind -Term)) (out (varKind -Term))))
    -lamTerm : Type → PHOPLcon (Π (Π -Term (out (varKind -Term))) (out (varKind -Term)))
    -ref : PHOPLcon (Π (out (varKind -Term)) (out (varKind -Path)))
    -imp* : PHOPLcon (Π (out (varKind -Path)) (Π (out (varKind -Path)) (out (varKind -Path))))
    -univ : PHOPLcon (Π (out (varKind -Term)) (Π (out (varKind -Term)) (Π (out (varKind -Proof)) (Π (out (varKind -Proof)) (out (varKind -Path))))))
    -lll : Type → PHOPLcon (Π (Π -Term (Π -Term (Π -Path (out (varKind -Path))))) (out (varKind -Path)))
    -app* : PHOPLcon (Π (out (varKind -Term)) (Π (out (varKind -Term)) (Π (out (varKind -Path)) (Π (out (varKind -Path)) (out (varKind -Path))))))
    -plus : PHOPLcon (Π (out (varKind -Path)) (out (varKind -Proof)))
    -minus : PHOPLcon (Π (out (varKind -Path)) (out (varKind -Proof)))
    -eq : Type → PHOPLcon (Π (out (varKind -Term)) (Π (out (varKind -Term)) (out (nonVarKind -Equation))))
